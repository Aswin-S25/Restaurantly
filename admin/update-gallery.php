...
<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql2 = "SELECT * FROM tbl_gallery WHERE id=$id";
        //execute the Query
                ...
                <td>
                    <?php 
                        ...
                        else
                        {
                            //Image Available
                            ?>
                            <img src="<?php echo SITEURL; ?>assets/img/gallery/<?php echo $current_image; ?>" width="150px">
                            <?php
                        }
                    ?>
                </td>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $dest_path = "../assets/img/gallery/".$image_name; //DEstination Path
                        ...
                        if($current_image!="")
                        {
                            ...
                            //REmove the image
                            $remove_path = "../assets/img/gallery/".$current_image;
