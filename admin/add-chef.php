        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td>Position: </td>
                    <td>
                        <textarea name="position" cols="30" rows="5" placeholder="Description of the Food."></textarea>
                    </td>
                </tr>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        $dst = "../assets/img/chefs/".$image_name;
                ...
                if($res2 == true)
                {
                    $_SESSION['add'] = "<div class = 'success'>chef Added Successfully</div>";
                    header('location:'.SITEURL.'admin/manage-chef.php');
                }
                else
                {
                    $_SESSION['add'] = "<div class = 'error'>Failed to add chef...</div>";
                    header('location:'.SITEURL.'admin/manage-chef.php');
                }
